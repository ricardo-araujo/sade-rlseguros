        ...
        <div class="card" style="margin: 5px">
            <div class="card-header" id="licitacao-{{ $licitacao->id }}">
                <h5 class="mb-0">
                    ...
                    <a href="{{ action('LicitacaoCNController@download', [$licitacao]) }}" class="btn btn-outline-dark" style="float: right" title="Clique para baixar os arquivos da oportunidade. (Disponibilizado às {{$licitacao->dt_registro_edital->format('H:i:s')}})" download>
