...
class BackupCommand extends Command
{
    ...
    public function handle()
    {
        try {
            ...
            $process = new Process(sprintf('find %s -maxdepth 1 -type f -mtime +1 | xargs rm', storage_path('*.sql'))); // busca todos os arquivos sql em storage criados a mais de 1 dia e remove-o p/ manter versao mais atual
            $process->run();
