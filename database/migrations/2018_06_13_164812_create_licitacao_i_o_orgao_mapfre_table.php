...
class CreateLicitacaoIOOrgaoMapfreTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql_io')->create('licitacao_orgao', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::connection('mysql_io')->dropIfExists('licitacao_orgao');
    }
}
